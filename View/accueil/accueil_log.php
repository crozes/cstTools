                ...
                <div class="mask rgba-gradient d-flex justify-content-center align-items-center">
                    ...
                    <div class="container">
                        ...
                        <!--Grid column-->
                            ...
                            <!--Grid column-->
                            <div class="col-md-6 text-light text-right text-md-left mt-xl-5 mb-5" >
                                <h1 class="h1-responsive font-weight-bold mt-sm-5 text-right">Administration</h1>
                                <hr class="hr-light">
                                <h6 class="mb-4 text-light text-right">Permet de générer l\'ensemble des données qui sont renseigné par les personnes, ainsi que les personnes ayant un compte sur CST Tools</a>
                                <a name="" id="" class="btn btn-danger" href="?page=admin" role="button">GO !</a>
                            </div>
                            <!--Grid column-->
                        </div>
                    <!--Grid row-->
