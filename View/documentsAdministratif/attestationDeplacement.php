                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text"
                                class="form-control" name="lieuExe" id="lieuExe" aria-describedby="lieuExe" placeholder="Toulouse" require>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text"
                                class="form-control" name="natExe" id="natExe" aria-describedby="natExe" placeholder="Formation secourisme" require>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text"
                                class="form-control" name="moyDep" id="moyDep" aria-describedby="moyDep" placeholder="A la convention du licencié" require>
                        </div>
                    </div>
                </div>        
            </form>            
